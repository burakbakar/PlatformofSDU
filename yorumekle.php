...
<form action="" method="post">
	...
	<table class="table">
		...
		<tr>
			<td>YORUMUNUZU YAZINIZ</td>
			<td><input type="text" name="yorum" class="form-control" ></td>
		</tr>
...
if ($_POST) { // Sayfada post olup olmadığını kontrol ediyoruz.
	...
	if ($yorum<>"") { // Veri alanlarının boş olmadığını kontrol ettiriyoruz. başka kontrollerde yapabilirsiniz.
		
		if ($baglanti->query("INSERT INTO yorumlar (yorum) VALUES ('$yorum')")) // Veri ekleme sorgumuzu yazıyoruz.
		{
