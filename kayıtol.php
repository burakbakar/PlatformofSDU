...
<form action="" method="post">
	...
	<table class="table">
		...
		<tr>
			<td>Şifre</td>
			<td><input type="password" name="ksifre" class="form-control" ></td>
		</tr>
		

		<tr>
			<td></td>
			<td><input class="btn btn-primary"  type="submit" value="Kaydol"></td>
		</tr>
...
if ($_POST) { // Sayfada post olup olmadığını kontrol ediyoruz.
	...
	if ($kadi<>"" && $ksifre<>"") { // Veri alanlarının boş olmadığını kontrol ettiriyoruz. başka kontrollerde yapabilirsiniz.
		
		if ($baglanti->query("INSERT INTO uyeler (kadi,parola) VALUES ('$kadi','$ksifre')")) // Veri ekleme sorgumuzu yazıyoruz.
		{
